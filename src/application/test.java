...
//    final ColorChooser colorChooser = new ColorChooser();  // to use the full web palette, just use the default constructor.
        ...
        final Scene scene = new Scene(colorChooser, 400, 500);
...
class ColorChooser extends VBox {
    ...
    private final ReadOnlyObjectWrapper<Color> chosenColor = new ReadOnlyObjectWrapper<>();
    ...
    private final ReadOnlyObjectWrapper<String> chosenColorName = new ReadOnlyObjectWrapper<>();
